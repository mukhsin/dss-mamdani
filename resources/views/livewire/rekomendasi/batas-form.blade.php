...
new class extends Component {
    ...
    public function next(): void
    {
        ...
        $this->batas->batas_sedang_modal = $validated['batas_sedang_modal'];
        ...
        $this->batas->batas_sedang_keuntungan = $validated['batas_sedang_keuntungan'];
        ...
        $this->batas->batas_sedang_diskon = $validated['batas_sedang_diskon'];
        ...
        <div class="flex flex-col gap-8">
            <div class="flex-1 flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-2 w-1/2">
                    ...
                    <x-mary-input label="{{ __('Batas Sedang Modal') }}" wire:model="batas_sedang_modal" prefix="Rp"/>
                    <x-mary-input label="{{ __('Batas Besar Modal') }}" wire:model="batas_besar_modal" prefix="Rp"/>
                    <x-mary-input label="{{ __('Batas Kecil Keuntungan') }}" wire:model="batas_kecil_keuntungan"
                                  prefix="Rp"/>
                    <x-mary-input label="{{ __('Batas Sedang Keuntungan') }}" wire:model="batas_sedang_keuntungan"
                                  prefix="Rp"/>
                    <x-mary-input label="{{ __('Batas Besar Keuntungan') }}" wire:model="batas_besar_keuntungan"
                                  prefix="Rp"/>
                </div>
            </div>
            <div class="flex-1 flex flex-col gap-4">
